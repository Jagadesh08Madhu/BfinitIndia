...
export default function HomeSupport() {
  return (
    <section className='font-plus py-20 px-10 lg:mx-32'>
      <h1 style={{letterSpacing:"3px"}} className='font-semibold text-center text-4xl pb-5 text-[#5667ff]'>Our customer support</h1>
      <div className='flex gap-10 flex-col lg:flex-row items-center'>
        <div className='lg:w-1/2 flex flex-col gap-5 order-2 lg:order-1'>
            <h1 className='lg:text-4xl text-2xl'>24/7 assistance to ensure your website success</h1>
