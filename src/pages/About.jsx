  ...
  return (
    <section>
      ...
      <div className="mx-5 py-10 grid place-items-center gap-4 md:container md:mx-auto lg:py-28 lg:grid-cols-2 lg:gap-8">
        <div className="flex flex-col gap-4 md:gap-8">
          ...
          <div className="flex gap-4">
            <Link
              to={"/contact"}
              className="group flex w-fit items-center gap-4 rounded border border-[#5667ff] bg-[#5667ff] px-4 py-2 font-semibold text-white shadow duration-300 ease-linear hover:bg-transparent hover:text-[#5667ff]"
            >
      ...
      <div className="mx-5 my-10 flex flex-col gap-4 md:container md:mx-auto md:gap-8 lg:my-20">
        <h5 className="font-semibold text-[#5667ff] md:text-2xl">
        ...
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-3">
          {items.map((item, i) => (
            <div key={i}>
              ...
              <div className="mt-5">
                <h5 className="text-xl font-semibold text-[#5667ff]">
                  {item.title}
                </h5>
